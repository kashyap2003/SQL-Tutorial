...
FROM student
ORDER BY major, student_id DESC; -- This will arrange first with major and then if there is any same student_id Then it will arrange it in Decending order.
LIMIT 3; -- This will give us only 3 rows of starting.
