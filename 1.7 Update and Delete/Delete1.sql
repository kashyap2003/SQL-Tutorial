...
DELETE FROM student -- It will delete row from student
WHERE name = 'Tom' AND major = 'undecided'; -- This will delete the row which has name Tom and major of Undecided.
